package com.drazuam.omnimancy.client.enchantment.lib;

/**
 * Created by Joel on 2/19/2017.
 */
public class LibResources {
    public static final String PREFIX_MOD = "omnimancy:";

    public static final String PREFIX_LANG = "/assets/omnimancy/lang/";
