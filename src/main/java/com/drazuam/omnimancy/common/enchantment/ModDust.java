...
import com.drazuam.omnimancy.common.enchantment.Symbols.*;
...
public class ModDust {
    ...
    public enum ConnectionType{
        ...
        {
            if(newLocation==null)
                texture = new ResourceLocation(Omnimancy.MODID,"textures/block/dustConnectLineDefault.png");
            else
                texture = new ResourceLocation(Omnimancy.MODID, newLocation);
        }
    }
