...
public class DustSymbolDickButt extends DefaultDustSymbol {
    public static final String MODEL_LOCATION = Reference.Model_Location +"dustDickbutt";
    public static final String TEXTURE_LOCATION = Reference.Texture_Location + "dustDickbutt.png";
