...
public class DustSymbolOr extends DefaultDustSymbol {
    ...
    public static final String MODEL_LOCATION = Reference.Model_Location + "dustCombine";
    public static final String TEXTURE_LOCATION = Reference.Texture_Location + "dustCombine.png";
