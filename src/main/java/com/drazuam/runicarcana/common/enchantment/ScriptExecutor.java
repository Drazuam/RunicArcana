...
//    }
    ...
    public Object resolveInput(short SigID)
    {
        ...
        {
            RunicItem.setStackDisplayName("Dust Overflow - Too many inputs in a row!");
            RunicItem.getTagCompound().removeTag("omniScript");
            done();
            return null;
        }
        ...
        catch(StackOverflowError|NullPointerException e)
        {
            if(e instanceof NullPointerException){
                RunicItem.setStackDisplayName("Null Dust");
                RunicItem.getTagCompound().removeTag("omniScript");
                done();
            }
            else {
                RunicItem.setStackDisplayName("Dust Overflow");
                RunicItem.getTagCompound().removeTag("omniScript");
                done();
            }
        }
